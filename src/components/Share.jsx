      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.icons}>
          <svg
            ...
            height="20"
            role="img"
            aria-describedby="fb-icon"
          >
            <title id="fb-icon">Facebook Icon</title>
            <path
              fill="#FFF"
          ...
          <svg
            ...
            height="17"
            role="img"
            aria-describedby="twt-icon"
          >
            <title id="twt-icon">Twitter Icon</title>
            <path
              fill="#FFF"
          ...
          <svg
            ...
            height="20"
            role="img"
            aria-labelledby="prt-icon"
          >
            <title id="prt-icon">Printerest Icon</title>
            <path
              fill="#FFF"
